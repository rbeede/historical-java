/*
   ...
   A sample Dialog to illustrate the placing of GUI objects and event handling
*/

import java.awt.*;
import java.awt.event.*;

class MyFirstDialog extends Dialog implements ActionListener
{
...
******************/
   ...
   public MyFirstDialog(Frame owner)
   {
      this(owner, true);
   }

   public MyFirstDialog(Frame owner, boolean modal)
   {
      super(owner, modal);
      //set the frame properties
      setSize      (FRAME_WIDTH, FRAME_HEIGHT);
      setResizable (false);
      setTitle     ("Program MyFirstDialog");
