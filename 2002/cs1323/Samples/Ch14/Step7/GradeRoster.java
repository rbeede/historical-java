 ...
 ***************************/
    ...
    public void computeGrades( )
    {
        for (int i = 0; i < rosterSize; i++) {
            ...
            System.out.print(roster[i].getName() + "  ");         //TEMP
            System.out.print(roster[i].getTestScore(1) + "  ");   //TEMP
            System.out.print(roster[i].getTestScore(2) + "  ");   //TEMP
            System.out.print(roster[i].getTestScore(3) + "  ");   //TEMP
            System.out.println(roster[i].getCourseGrade());       //TEMP
        }
    }
    ...
    public Student[] getAllStudents()
    {
        ...
        if (rosterSize > 0) {
           ...
           student = new Student[rosterSize];
