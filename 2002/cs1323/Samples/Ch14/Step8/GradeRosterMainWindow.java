/*
   Program GradeRosterMainWindow (Step 8)

   This program maintains a class roster of student names and grades.

   Step 8: Define and add GradeRosterStorage to the program. Implement the menu
           choices Save, Save As, and Open.
 ...
 ***************************/
    ...
    private GradeRosterStorage  gradeRosterStorage;
 ...
 ***************************/
    ...
    public GradeRosterMainWindow()
    {
        ...
        gradeRosterStorage = new GradeRosterStorage(this);
    }
 ...
 ***************************/
    ...
    {
        GradeRoster roster = gradeRosterStorage.open();

        if (roster == null) {
            messageBox.show("Error: open failed");
        }
        else {
            gradeRosterControl.setGradeRoster(roster);
        }
    }
    ...
    private void saveRoster()
    {
        ...
        boolean     success = gradeRosterStorage.save( roster );

        if (!success) {
            messageBox.show("Error: No data was saved to a file");
        }
    }
    ...
    {
        GradeRoster roster  = gradeRosterControl.getRoster();
        boolean     success = gradeRosterStorage.saveAs( roster );
