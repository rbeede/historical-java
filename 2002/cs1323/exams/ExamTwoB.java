...
class ExamTwoB
{
	...
	{	
		//1. What is the value of sum after this code segment is executed?
		...
		*/
		...
		//2. What is the value of sum after this code segment is executed?
		/*
		int sum = 0;
			for ( int i = 0 ; i <= 1 ; i++ ) {
				for (int j = 4; j > 2*i; j--){
		...
		*/
		...
		//3. What is the output after the following code segment is executed?
			/*
		...
		*/
		...
		//4. Which code segment will output the following configuration?
		//*$
		//**$
		//***$
		//****$
		...
		*/
		...
		/*
		6. Which standard coding scheme does Java use to represent characters?
		...
		*/
		...
		//7. What is the output after the following code segment is executed?
		/*
		...
		*/
		...
		//8. What is the output after the following code segment is executed?
		...
		*/
		...
		//9. What is the output after the following code segment is executed?
		/*
			String str = "Caffeine";
		...
		*/
		...
		//10. What is the output after the following code segment is executed?
		/*
		...
		*/
		...
		//11. What is the output after the following program is executed?
				/*
		...
		*/
		...
		//12. What is the value of vowelCount after this code segment executes?
		...
		*/
		...
		//13. What is output after the following code segment executes?
		/*
		...
		*/
		...
		/*
		14. Which of the following is a valid statement?
		a. Person [25] person;
		...
		*/
		...
		//15. What is the output from the following program?
		/*
			TestExam test = new TestExam();
		...
		*/
		...
		//17. Identify the problem in the following method.
		...
		*/
		...
		//18.  Identify the valid if statement:
		...
		*/
		...
		//19.  Which of the following boolean expressions evaluates to true?
		//a.
					/*
				   if (! ( 18    ==  ( 10 + 8 ) ))
		...
		*/
		...
		// 21. Which case demonstrates correct syntax for a switch statement?
			/*
			switch (x) {
				case number > 10:	y = 4;
									break;
		...
		*/
		...
		//22. Which of the two following if statements are equivalent?
		...
		*/
		...
		//23. Identify the boolean expressions that evaluate to true. (assume x is 10, y is 20, and z is 30).
		//Expression #1:	
					/*	
					if( x < 10 || y > 10)
						System.out.println("true");
		...
		*/
		...
		//24. What is the value of minimum after this code segment executes?
		/*
		int num1 = 12;
		int num2 = 26;
		int num3 = 45;
		...
		*/
		...
		//26. Determine the value of sum after the loop is executed?
		/*
		int count = 0, sum = 0;
		while ( count < 20 ) {
		sum += 3 * count;
		...
		*/
		...
		//27. What is the value of count after this code segment is executed?
		/*
		int count = 0;
		do{
			count = count + 1;	
		...
		*/
		...
		/*
		28. How many distinct characters can you represent using 8 bits (this is also the number of symbols represented by ASCII code)?
		a. 7
		b. 8
		c. 128
		d. 256 - ANSWER
		...
		*/
		...
		//29. What is the value of power after this code segment is executed?
		/*
		int power = 1;
		int count = 1;
		while ( power  < 100){
		...
		*/
		...
		//30. What is the value of answer after this code segment is executed?
		/*
		int x=0, answer = 0;
			int j = 1  +  ++x;
