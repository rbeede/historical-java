...
public class JtoHTML {
	...
	public static void main(String args[]) {
		...
		//Create a parser object.  It will automatically parse our
		//keyword/color pairs
...
/*CUT THIS OUT AND MOVE IT
	//**********************************************************************
	// Method:  saveToFile
	//
	// Preconditions:  String objDataToSave - data to write to file
	//		   String objFileToSave - filename to write to
	//
	// Postconditions:  No return values
	//
	// Description:  This method simply takes the passed data from
	//	objDataToSave and stores it in objFileToSave
	//
	//**********************************************************************
	public type saveToFile( String objDataToSave, objFileToSave ) {
		//Make sure we got passed our params
		if( (objDataToSave == null) || (objFileToSave == null) ) {
			System.out.println( "You failed to correctly pass " +
			   "your paramaters in saveToFile method. );
			return;  //Leave method
		}

		//Create our file I/O objects
		FileWriter objOutFile = new FileWriter(objFileToSave);
		BufferedWriter objWriter = new BufferedWriter(objOutFile);
		
		//Save our passed data
		objWriter.write( objDataToSave );
