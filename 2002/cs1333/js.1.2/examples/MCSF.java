...
public class MCSF {
	...
	{
	    q.add(new ComparableEdge((Edge)ei.value()));
	}

	while (!q.isEmpty())
	{
	    ComparableEdge oe = (ComparableEdge)q.remove();
	    Edge e = oe.edge();
...
class ComparableEdge implements Comparable
{
    Edge e;
    public ComparableEdge(Edge initial)
    {
	e = initial;
    }
    public Edge edge()
    ...
    {
	return  ((Comparable)(e.label())).compareTo(
	        ((ComparableEdge)a).edge().label());
    }
}
