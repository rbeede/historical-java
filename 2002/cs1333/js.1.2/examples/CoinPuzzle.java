...
class State
{
    public static final int DIME=0;    // representations of coins
    public static final int PENNY=1;
    public static final int NICKEL=2;
    public static final int QUARTER=3;
    public static final int LEFT = -1; // representations of directions
    ...
    public State()
    // post: constuct initial layout of coins
    //-stateInterface
    {
	position = new int[4];
	position[DIME] = 3;
    ...
    // post: returns true if coin can be moved in the desired direction
    //-stateInterface
    {
	int p = position[coin];
	int np = p + direction;
    ...
    public int id()
    // post: constuct an integer representing state.
    //       states of coins are equal iff id's are equal
    //-stateInterface
    {
	return (((position[QUARTER]*5)+position[DIME])*5+position[NICKEL])*5+position[PENNY];
    }
	
    public String toString()
    // post: return string representation of this move.
    {
	return "dime="+position[DIME]+" penny="+position[PENNY]+" nickel="+
	    position[NICKEL]+" quarter="+position[QUARTER];
    }
    //+stateInterface
}
//-stateInterface
